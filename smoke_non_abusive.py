...
async def run_smoke():
    q = asyncio.Queue()
    a_msgs = ["Hi, this is A", "How are you, B?", "I think we should meet tomorrow"]
    b_msgs = ["Hey A, I am B", "I'm fine thanks", "That sounds good to me"]
