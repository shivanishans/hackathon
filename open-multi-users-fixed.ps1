...
Write-Host "`n🎯 What to expect in CMD:" -ForegroundColor Cyan
Write-Host "   🔌 SOCKET X CONNECTED: User 'Username'" -ForegroundColor Gray
Write-Host "   📊 ACTIVE SOCKET CONNECTIONS (X total)" -ForegroundColor Gray
Write-Host "   🤖 ML moderation will flag abusive messages" -ForegroundColor Gray